...
export default function PortfolioV2() {
  ...
  const skills = [
    { category: "Frontend", items: ["HTML", "CSS", "JavaScript", "React", "Tailwind CSS", 'Vue'] },
    { category: "Backend", items: ["Laravel", "Java", "Spring Boot", "Kotlin", "Untiy", "MongoDB", "SQL"] },
  ...
  const education = [
    ...
    },
    {
      ...
      institution: "Insitut Nicolau Copèrnic",
      description: "Estudios centrados en desarrollo de aplicaciones móviles y multiplataforma.",
    },
    {
      period: "2020 - 2022",
      title: "Grade de Sistemas Microinformáticos y Redes",
      institution: "Insitut Nicolau Copèrnic",
      description: "Estudios centrados en sistemas, redes y seguridad informática.",
    },
  ]
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-[#0f172a]/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 flex justify-between items-center h-16">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl hidden sm:block">Juan Flores</span>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                  Soy un desarrollador Full Stack Junior con pasión por la tecnología y el aprendizaje continuo. Me encanta enfrentar nuevos desafíos.
                </p>
                ...
                <div className="mt-12 flex gap-4">
                  <a
                    href="https://github.com/Juanfonsi"
                  ...
                  <a
                    href="https://www.linkedin.com/in/juan-flores-fernandez-507200207/"
                    className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:text-teal-500 dark:hover:text-teal-400 transition-colors"
                  >
                    <Linkedin size={20} />
                  </a>
              ...
              >
                <div className="relative">
                  ...
                  <div className="w-64 h-64 md:w-80 md:h-80 rounded-full border-2 border-gray-200 dark:border-gray-800 overflow-hidden relative z-10">
                    <img
                      src="/juanflores.jpg?height=400&width=400"
                      alt="Tu foto"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Siempre estoy en búsqueda de nuevas oportunidades para mejorar mis habilidades y contribuir con proyectos que marquen la diferencia.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Soy un desarrollador Full Stack Junior con pasión por aprender nuevas tecnologías y crear soluciones innovadoras.
                  Mi objetivo es combinar diseño y funcionalidad para ofrecer experiencias de usuario excepcionales.
                </p>
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Actualmente, estoy enfocado en el desarrollo frontend con React y el backend con Laravel,
                  pero también tengo experiencia con Vue.js, bases de datos y Java entre otros.
                  Me encanta resolver problemas, optimizar aplicaciones y trabajar en equipo para crear productos de calidad.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  ...
                  <div className="p-4 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
                    <div className="text-3xl font-bold text-indigo-500 dark:text-indigo-400 mb-1">3+</div>
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-6">He trabajado con</h3>
        ...
        <section id="projects" className="py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="text-3xl font-bold mb-4">Mis ultimos proyectos</h2>
              <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              ...
              <span className="font-bold">Juan Flores</span>
            </div>

            <div className="text-gray-500 dark:text-gray-400 text-sm">
              © {new Date().getFullYear()} Juan Flores. Todos los derechos reservados.
            </div>
